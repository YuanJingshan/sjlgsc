...
$(function() { 
	...
	// 分页
	setParam(10,"manage/fruits/type/count","manage/fruits/type/pageList","pageSize=10&pageNum=");
	getPageCount();
	getPageAndDisplay();
...
function batchDelete() {
	if (getSelectId().idStr == '') {
		...
		processAndReturnCode('manage/fruits/type/batchDelete', "idStr=" + getSelectId().idStr);
	}
}
