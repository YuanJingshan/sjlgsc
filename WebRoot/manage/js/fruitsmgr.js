...
$(function() { 
	...
	// 分页
	setParam(10,"manage/fruits/mgr/count","manage/fruits/mgr/pageList","pageSize=10&pageNum=");
	getPageCount();
	getPageAndDisplay();
...
function batchDelete() {
	if (getSelectId().idStr == '') {
		...
		processAndReturnCode('manage/fruits/mgr/batchDelete', "idStr=" + getSelectId().idStr);
	}
}
