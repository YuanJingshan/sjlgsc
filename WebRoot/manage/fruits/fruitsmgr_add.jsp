    ...
    <div class="body_right">
    	<div class="body_right_1">
        	<div class="body_right_top">
           	  <p class="body_right_top_left"><a href="bpage/page/index.jsp">首页</a>&nbsp;>&nbsp;<strong>水果</strong>&nbsp;>&nbsp;添加</p>
              <div class="clear"></div>
            </div>
            	...
            	<form id="fruits-form" method="post" enctype="multipart/form-data">
	            	...
	            	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ty_bg_r">
	                  ...
	                  <tr>
	                    ...
	                    <th width="10%">图片</th>
	                    <td width="26%" align="left">
	                    	<input id="item_picture" name="item_picture" type="file" class="ty_k"/>
	                    </td>
	                  ...
	                  <tr>
	                    <td colspan="6" align="center">
	                    	<div style="width:260px; margin-left:auto; margin-right:auto;">
	                            ...
	                            <a href="javascript:void(0);" onclick="submitForm('fruits-form', 'manage/fruits/mgr/add');" class="submit">提　交</a>
	                        </div>
	                    </td>
	                  </tr>
	                </table>
