    ...
    <div class="body_right">
    	<div class="body_right_1">
        	<div class="body_right_top">
           	  <p class="body_right_top_left"><a href="bpage/page/index.jsp">首页</a>&nbsp;>&nbsp;<strong>基础信息</strong>&nbsp;>&nbsp;添加</p>
              <div class="clear"></div>
            </div>
	                  ...
	                  <tr>
	                    <td colspan="6" align="center">
	                    	<div style="width:260px; margin-left:auto; margin-right:auto;">
	                            ...
	                            <a href="javascript:void(0);" onclick="submitForm('fruits-form', 'manage/base/add');" class="submit">提　交</a>
	                        </div>
	                    </td>
	                  </tr>
	                </table>
